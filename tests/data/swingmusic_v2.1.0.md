...
This release fixes a critical security vulnerability that allowed an authenticated user to download an arbitrary file from the host server via the streaming endpoint\. Fix commit: https://github\.com/swingmx/swingmusic/commit/d7e2710d4a726491a43b2c86b9cc042990d2d80e
